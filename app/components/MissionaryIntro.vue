      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div class="gs-missionary-img-wrap relative w-full max-w-[460px]">
            ...
            <div class="relative overflow-hidden rounded-[24px] shadow-[rgba(45,42,38,0.08)_0_12px_32px] border border-[#E8E3DD] z-10 bg-white">
              <div class="aspect-[4/3] w-full overflow-hidden">
                <img 
                  src="/images/mock/missionary_family.png" 
            ...
            <div class="absolute -bottom-6 -right-4 bg-[#FFFFFF] p-5 rounded-[16px] shadow-[rgba(45,42,38,0.06)_0_8px_24px] border border-[#E8E3DD] z-20 hidden sm:block max-w-[180px]">
              <div class="flex flex-col items-center text-center">
                ...
                <p class="text-[12px] font-bold text-[#171717] tracking-wider uppercase mb-0.5">EST. 2006</p>
                <p class="text-[10px] text-[#7A7571] font-medium uppercase tracking-wider">South America</p>
              </div>
            </div>
        ...
        <div class="lg:col-span-7 flex flex-col items-start gs-missionary-text-wrap">
          ...
          <span class="uppercase tracking-[0.25em] font-bold text-[11px] text-[#E87A5D] mb-4">
            {{ $t('missionary.title') }} <span class="text-[#171717]">{{ $t('missionary.highlight') }}</span>
          </span>
          ...
          <div class="flex flex-col gap-6 text-[#524E4A] max-w-[620px] mb-10 leading-[1.6]">
            <p class="text-[16px] font-normal">
              {{ $t('missionary.description1') }}
            </p>
            <p class="text-[16px] font-normal">
              {{ $t('missionary.description2') }}
            </p>
          </div>
