    ...
    <div v-if="editor" class="tiptap-toolbar">
      ...
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          <path
            d="M15.6 11.8c.9-.7 1.4-1.7 1.4-2.8C17 6.2 14.8 4 12 4H6v16h6.5c2.6 0 4.5-2.1 4.5-4.5 0-1.5-.8-2.8-1.9-3.7zM9 7h3c1.1 0 2 .9 2 2s-.9 2-2 2H9V7zm3.5 10H9v-4h3.5c1.4 0 2.5 1.1 2.5 2.5S13.9 17 12.5 17z"
          />
        </svg>
      </button>
      <button
      ...
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          <path d="M11.5 4v2h2.2L9.8 18H7.5v2h7v-2h-2.2l3.9-12h2.3V4z" />
        </svg>
      </button>
      <button
        type="button"
      ...
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          <path
            d="M12 17c3.3 0 6-2.7 6-6V3h-2.5v8c0 1.9-1.6 3.5-3.5 3.5S8.5 12.9 8.5 11V3H6v8c0 3.3 2.7 6 6 6zm-7 2v2h14v-2H5z"
          />
        </svg>
      </button>
      ...
      <button
        ...
        aria-label="H2"
      >
        <span style="font-size: 11px; font-weight: 700; letter-spacing: -0.03em"
          >H2</span
        >
      </button>
      <button
